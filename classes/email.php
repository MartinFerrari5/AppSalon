...
class Email {
    ...
    public function enviar(){
        ...
        Confirma tu email</p>";
        $contenido.= "<a href='http://localhost:3000/public/creado?token=" .$this->token . "'>Confirmar cuenta </a>";
        $contenido.="</html>";
        $mail->Body=$contenido;
        // ENVIAR
        $mail->send();
    ...
    public function recover(){
        ...
        $contenido.= "<a href='http://localhost:3000/public/confirmado/recover?token=" .$this->token . "'>New Password </a>";
        $contenido.="</html>";
        $mail->Body=$contenido;
        // ENVIAR
        $mail->send();
