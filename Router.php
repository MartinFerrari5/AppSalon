...
class Router
{
    ...
    public function comprobarRutas()
    {
        ...
        if ( $fn ) {
            ...
            /* Call user fn va a llamar una función cuando no sabemos cual
             sera*/
        ...
        foreach ($datos as $key => $value) {
            $$key = $value;  /*Doble signo de dolar significa: variable variable,
             básicamente nuestra variable sigue siendo la original,
              pero al asignarla a otra no la reescribe, mantiene su
               valor, de esta forma el nombre de la variable se
                asigna dinamicamente*/
        }
